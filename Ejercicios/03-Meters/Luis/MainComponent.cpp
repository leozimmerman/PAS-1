...
void MainComponent::paint (juce::Graphics& g)
{
    ...
    auto bounds = getLocalBounds().reduced (20); // le quita ancho de los costados
    ...
    for (int i = 0; i < numBars; ++i)
    {
        ...
        auto h = juce::roundToInt ((float) barsArea.getHeight() * value * 2);
        ...
        // Bar
        if( value > 0.10){g.setColour (juce::Colours::red);}
       ...
       // g.setColour (juce::Colours::limegreen);
        ...
        auto labelBounds = juce::Rectangle<int> ( bar.getWidth(),
                                                 bounds.getBottom(),
                                                 bar.getX(),
                                                 labelHeight);
